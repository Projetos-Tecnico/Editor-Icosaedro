...
Abrir `Projeto Isocaedro.slnx` no Visual Studio e executar, ou compilar pela
linha de comando:

```bash
MSBuild.exe "Projeto Isocaedro/Projeto Isocaedro.csproj" /t:Build /p:Configuration=Debug
```
